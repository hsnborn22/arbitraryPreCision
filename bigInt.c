...
int main(void) {
  printf("Product between: 101 and 222. Expected result: 22422 "); 
bigInt bigNum1 = initBigInt("101");
bigInt bigNum2 = initBigInt("222");
...
free(bigNum3->digits);
free(bigNum3);
printf("Product between: 11 and -5. Expected result: -55 "); 
bigNum1 = initBigInt("11");
bigNum2 = initBigInt("-5");
...
free(bigNum3->digits);
free(bigNum3);
printf("Product between: 251 and -3. Expected result: -753 "); 
bigNum1 = initBigInt("251");
bigNum2 = initBigInt("-3");
bigNum3 = naiveMultiplication(&bigNum1, &bigNum2); 
printf(" Representation: %s\n Digit Count: %d \n Sign: %d\n", bigNum3->representation, bigNum3->digitCount, bigNum3->sign); 
for (int i = 0; i < bigNum3->digitCount; i++) {
 printf("%d \n", bigNum3->digits[i]);
...
free(bigNum3->digits);
free(bigNum3);
printf("Product between: 44 and 1. Expected result: 44 "); 
bigNum1 = initBigInt("44");
bigNum2 = initBigInt("1");
bigNum3 = naiveMultiplication(&bigNum1, &bigNum2); 
printf(" Representation: %s\n Digit Count: %d \n Sign: %d\n", bigNum3->representation, bigNum3->digitCount, bigNum3->sign); 
for (int i = 0; i < bigNum3->digitCount; i++) {
 printf("%d \n", bigNum3->digits[i]);
...
free(bigNum3->digits);
free(bigNum3);
printf("Product between: 0 and 0. Expected result: 0 "); 
bigNum1 = initBigInt("0");
bigNum2 = initBigInt("0");
bigNum3 = naiveMultiplication(&bigNum1, &bigNum2); 
printf(" Representation: %s\n Digit Count: %d \n Sign: %d\n", bigNum3->representation, bigNum3->digitCount, bigNum3->sign); 
for (int i = 0; i < bigNum3->digitCount; i++) {
 printf("%d \n", bigNum3->digits[i]);
...
free(bigNum3->digits);
free(bigNum3);
printf("Product between: 8 and 7. Expected result: 56 "); 
bigNum1 = initBigInt("8");
bigNum2 = initBigInt("7");
bigNum3 = naiveMultiplication(&bigNum1, &bigNum2); 
printf(" Representation: %s\n Digit Count: %d \n Sign: %d\n", bigNum3->representation, bigNum3->digitCount, bigNum3->sign); 
for (int i = 0; i < bigNum3->digitCount; i++) {
 printf("%d \n", bigNum3->digits[i]);
...
free(bigNum3->digits);
free(bigNum3);
printf("Product between: 9867 and 111. Expected result: 1095237 "); 
bigNum1 = initBigInt("9867");
bigNum2 = initBigInt("111");
bigNum3 = naiveMultiplication(&bigNum1, &bigNum2); 
printf(" Representation: %s\n Digit Count: %d \n Sign: %d\n", bigNum3->representation, bigNum3->digitCount, bigNum3->sign); 
for (int i = 0; i < bigNum3->digitCount; i++) {
 printf("%d \n", bigNum3->digits[i]);
...
free(bigNum3->digits);
free(bigNum3);
printf("Product between: -122 and 78999. Expected result: -9637878 "); 
bigNum1 = initBigInt("-122");
bigNum2 = initBigInt("78999");
bigNum3 = naiveMultiplication(&bigNum1, &bigNum2); 
printf(" Representation: %s\n Digit Count: %d \n Sign: %d\n", bigNum3->representation, bigNum3->digitCount, bigNum3->sign); 
for (int i = 0; i < bigNum3->digitCount; i++) {
 printf("%d \n", bigNum3->digits[i]);
...
free(bigNum3->digits);
free(bigNum3);
printf("Product between: 987 and 111. Expected result: 109557 "); 
bigNum1 = initBigInt("987");
bigNum2 = initBigInt("111");
bigNum3 = naiveMultiplication(&bigNum1, &bigNum2); 
printf(" Representation: %s\n Digit Count: %d \n Sign: %d\n", bigNum3->representation, bigNum3->digitCount, bigNum3->sign); 
for (int i = 0; i < bigNum3->digitCount; i++) {
...
free(bigNum3->digits);
free(bigNum3);
printf("Product between: -718 and 661. Expected result: -474598 "); 
bigNum1 = initBigInt("-718");
bigNum2 = initBigInt("661");
bigNum3 = naiveMultiplication(&bigNum1, &bigNum2); 
printf(" Representation: %s\n Digit Count: %d \n Sign: %d\n", bigNum3->representation, bigNum3->digitCount, bigNum3->sign); 
for (int i = 0; i < bigNum3->digitCount; i++) {
 printf("%d \n", bigNum3->digits[i]);
...
free(bigNum3->digits);
free(bigNum3);
printf("Product between: 581 and -11. Expected result: -6391 "); 
bigNum1 = initBigInt("581");
bigNum2 = initBigInt("-11");
bigNum3 = naiveMultiplication(&bigNum1, &bigNum2); 
printf(" Representation: %s\n Digit Count: %d \n Sign: %d\n", bigNum3->representation, bigNum3->digitCount, bigNum3->sign); 
for (int i = 0; i < bigNum3->digitCount; i++) {
 printf("%d \n", bigNum3->digits[i]);
...
free(bigNum3->digits);
free(bigNum3);
printf("Product between: 11 and 11. Expected result: 121 "); 
bigNum1 = initBigInt("11");
bigNum2 = initBigInt("11");
bigNum3 = naiveMultiplication(&bigNum1, &bigNum2); 
printf(" Representation: %s\n Digit Count: %d \n Sign: %d\n", bigNum3->representation, bigNum3->digitCount, bigNum3->sign); 
...
free(bigNum3->digits);
free(bigNum3);
printf("Product between: 222 and 901. Expected result: 200022 "); 
bigNum1 = initBigInt("222");
bigNum2 = initBigInt("901");
bigNum3 = naiveMultiplication(&bigNum1, &bigNum2); 
printf(" Representation: %s\n Digit Count: %d \n Sign: %d\n", bigNum3->representation, bigNum3->digitCount, bigNum3->sign); 
for (int i = 0; i < bigNum3->digitCount; i++) {
 printf("%d \n", bigNum3->digits[i]);
...
free(bigNum3->digits);
free(bigNum3);
printf("Product between: -45 and 23. Expected result: -1035 "); 
bigNum1 = initBigInt("-45");
bigNum2 = initBigInt("23");
bigNum3 = naiveMultiplication(&bigNum1, &bigNum2); 
printf(" Representation: %s\n Digit Count: %d \n Sign: %d\n", bigNum3->representation, bigNum3->digitCount, bigNum3->sign); 
for (int i = 0; i < bigNum3->digitCount; i++) {
 printf("%d \n", bigNum3->digits[i]);
...
free(bigNum3->digits);
free(bigNum3);
printf("Product between: -67 and 89. Expected result: -5963 "); 
bigNum1 = initBigInt("-67");
bigNum2 = initBigInt("89");
bigNum3 = naiveMultiplication(&bigNum1, &bigNum2); 
printf(" Representation: %s\n Digit Count: %d \n Sign: %d\n", bigNum3->representation, bigNum3->digitCount, bigNum3->sign); 
for (int i = 0; i < bigNum3->digitCount; i++) {
 printf("%d \n", bigNum3->digits[i]);
...
free(bigNum3->digits);
free(bigNum3);
printf("Product between: -12 and 34. Expected result: -408 "); 
bigNum1 = initBigInt("-12");
bigNum2 = initBigInt("34");
bigNum3 = naiveMultiplication(&bigNum1, &bigNum2); 
printf(" Representation: %s\n Digit Count: %d \n Sign: %d\n", bigNum3->representation, bigNum3->digitCount, bigNum3->sign); 
for (int i = 0; i < bigNum3->digitCount; i++) {
 printf("%d \n", bigNum3->digits[i]);
...
free(bigNum3->digits);
free(bigNum3);
printf("Product between: -56 and 78. Expected result: -4368 "); 
bigNum1 = initBigInt("-56");
bigNum2 = initBigInt("78");
bigNum3 = naiveMultiplication(&bigNum1, &bigNum2); 
printf(" Representation: %s\n Digit Count: %d \n Sign: %d\n", bigNum3->representation, bigNum3->digitCount, bigNum3->sign); 
for (int i = 0; i < bigNum3->digitCount; i++) {
 printf("%d \n", bigNum3->digits[i]);
...
free(bigNum3->digits);
free(bigNum3);
printf("Product between: -90 and 12. Expected result: -1080 "); 
bigNum1 = initBigInt("-90");
bigNum2 = initBigInt("12");
bigNum3 = naiveMultiplication(&bigNum1, &bigNum2); 
printf(" Representation: %s\n Digit Count: %d \n Sign: %d\n", bigNum3->representation, bigNum3->digitCount, bigNum3->sign); 
for (int i = 0; i < bigNum3->digitCount; i++) {
 printf("%d \n", bigNum3->digits[i]);
...
free(bigNum3->digits);
free(bigNum3);
printf("Product between: -34 and 56. Expected result: -1904 "); 
bigNum1 = initBigInt("-34");
bigNum2 = initBigInt("56");
bigNum3 = naiveMultiplication(&bigNum1, &bigNum2); 
printf(" Representation: %s\n Digit Count: %d \n Sign: %d\n", bigNum3->representation, bigNum3->digitCount, bigNum3->sign); 
for (int i = 0; i < bigNum3->digitCount; i++) {
 printf("%d \n", bigNum3->digits[i]);
...
free(bigNum3->digits);
free(bigNum3);
printf("Product between: -78 and 90. Expected result: -7020 "); 
bigNum1 = initBigInt("-78");
bigNum2 = initBigInt("90");
bigNum3 = naiveMultiplication(&bigNum1, &bigNum2); 
printf(" Representation: %s\n Digit Count: %d \n Sign: %d\n", bigNum3->representation, bigNum3->digitCount, bigNum3->sign); 
for (int i = 0; i < bigNum3->digitCount; i++) {
 printf("%d \n", bigNum3->digits[i]);
...
free(bigNum3->digits);
free(bigNum3);
printf("Product between: -23 and 45. Expected result: -1035 "); 
bigNum1 = initBigInt("-23");
bigNum2 = initBigInt("45");
bigNum3 = naiveMultiplication(&bigNum1, &bigNum2); 
printf(" Representation: %s\n Digit Count: %d \n Sign: %d\n", bigNum3->representation, bigNum3->digitCount, bigNum3->sign); 
for (int i = 0; i < bigNum3->digitCount; i++) {
 printf("%d \n", bigNum3->digits[i]);
